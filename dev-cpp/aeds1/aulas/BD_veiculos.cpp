...
int main() {
    ...
    // modelo, marca, tipo, combustivel, cambio, direcao, cor, portas, placa
    ...
    printf("\n\t\t * A placa do veículo mais barato é: %s e o valor da prestação é: %.2f \n", placaBarato, prestacaoBarato);
    printf("\n\t\t * A placa do veículo mais caro é: %s e seu valor é: R$ %.2f | O valor do seguro é: R$ %.2f \n", placaCaro, valorCaro, seguroCaro);
